...
export const APPLICATION_FIELD_OPTIONS = [
  ...
  { key: "BODY", label: "키·몸무게", defaultRequired: true, section: "BASIC", inputType: "COMPOSITE", order: 20, layout: "FULL", config: { fields: [{ key: "height", label: "키", inputType: "NUMBER", placeholder: "cm", unit: "cm" }, { key: "weight", label: "몸무게", inputType: "NUMBER", placeholder: "kg", unit: "kg" }] } },
  ...
  { key: "PHONE", label: "연락처", defaultRequired: true, section: "BASIC", inputType: "TEL", order: 50, layout: "HALF", config: { placeholder: "010-0000-0000" } },
  ...
  { key: "ADDRESS", label: "주소", defaultRequired: true, section: "BASIC", inputType: "TEXT", order: 70, layout: "FULL", config: { placeholder: "예: 서울특별시 마포구" } },
  ...
  { key: "LINK", label: "링크", defaultRequired: false, section: "ADDITIONAL", inputType: "URL", order: 20, layout: "FULL", config: { placeholder: "https://" } },
  ...
  { key: "COVER_LETTER", label: "자기소개", defaultRequired: false, section: "ADDITIONAL", inputType: "TEXTAREA", order: 40, layout: "FULL", config: { maxLength: 1000 } },
  ...
  { key: "MILITARY", label: "군필 여부", defaultRequired: false, section: "ADDITIONAL", inputType: "SELECT", order: 70, layout: "HALF", config: { options: ["군필", "미필", "해당 없음", "응답하지 않음"] } },
  ...
  { key: "VIDEO", label: "영상 링크", defaultRequired: true, section: "MATERIALS", inputType: "URL", order: 20, layout: "FULL", config: { placeholder: "YouTube 링크를 입력해 주세요.", maxCount: 10, videoRequirements: [] } },
] as const;
