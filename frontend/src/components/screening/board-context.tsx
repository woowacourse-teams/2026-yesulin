...
import type { ScreeningFilters } from "@/features/screening/filters";

export type BoardContextValue = {
  readonly board: ScreeningBoardResponse;
  readonly filters: ScreeningFilters;
  ...
  readonly setFilters: (update: (current: ScreeningFilters) => ScreeningFilters) => void;
