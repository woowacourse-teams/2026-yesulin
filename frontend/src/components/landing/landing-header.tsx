    ...
    <header className="glass-surface sticky top-0 z-30 border-x-0 border-t-0">
      <div className="mx-auto flex min-h-16 max-w-[1280px] items-center px-5 sm:min-h-[72px] sm:px-8 lg:px-10">
        ...
        <nav aria-label="주요 메뉴" className="ml-auto flex items-center gap-1.5 sm:gap-3">
          {!isProducer ? <Link href="/applicants/applications" className="hidden min-h-11 items-center justify-center rounded-control px-3 text-sm font-semibold text-muted-strong transition-colors hover:bg-surface hover:text-brand sm:inline-flex">내 지원서</Link> : null}
          <Link
            href="/login"
