...
export function PublicApplicationSaveNotice() {
  ...
  return <div role="status" className="mb-6 rounded-card border border-pass/20 bg-pass-bg px-4 py-3 text-sm leading-6 text-muted-strong"><strong className="text-pass">{state.draftRestored ? "이 기기에 저장된 작성 내용을 불러왔어요." : "이 기기에 저장됨"}</strong> 새로고침하거나 공고로 돌아와도 이 브라우저에서 이어 쓸 수 있어요.</div>;
}
