...
export function applicationDraftFromPrefill(prefill?: ProfilePrefillResponse) {
...
export function submissionValue(field: ApplicationFieldInput, draft: {
  ...
  if (field.inputType === "URL" && field.section === "MATERIALS") return draft.videoUrl;
