import type { ApplicationFieldInput, AuditionRoundInput, PerformanceRoleTemplate, PhotoRequirement, PostingRoleInput, VideoRequirement } from "@/features/auditions/creation-types";
