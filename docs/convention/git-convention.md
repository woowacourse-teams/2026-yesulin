...
- 이슈 생성과 동시에 프로젝트 보드에 추가하고 만든 사람에게 배정한다: `gh issue create --project "2026-yesulin" --assignee @me ...`.
...
- AI 도구를 공동 작성자로 표기하지 않는다. `Co-Authored-By: Claude`처럼 도구 이름을 꼬리말에 넣지 않는다.
