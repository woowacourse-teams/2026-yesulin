...
public enum SubmissionErrorCode implements ErrorCode {
    ...
    NOT_FOUND("SUBMISSION_NOT_FOUND", ErrorType.NOT_FOUND),
    IDEMPOTENCY_KEY_REUSED("IDEMPOTENCY_KEY_REUSED", ErrorType.CONFLICT),
    STALE_POSTING_SNAPSHOT("SUBMISSION_STALE_POSTING_SNAPSHOT", ErrorType.CONFLICT),
    DUPLICATE_SUBMISSION("DUPLICATE_SUBMISSION", ErrorType.CONFLICT),
