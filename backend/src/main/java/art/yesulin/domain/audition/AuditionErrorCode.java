...
public enum AuditionErrorCode implements ErrorCode {
    ...
    PUBLISHING_NOT_READY("AUDITION_PUBLISHING_NOT_READY", ErrorType.CONFLICT),
    PUBLISHING_CLOSED("AUDITION_PUBLISHING_CLOSED", ErrorType.CONFLICT),
    INVALID_STATUS("AUDITION_INVALID_STATUS", ErrorType.CONFLICT),
