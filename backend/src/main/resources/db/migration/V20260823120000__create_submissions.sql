...
(
    ...
    question_answers_present    boolean      not null,
    photo_requirement_answers_present boolean not null,
    video_requirement_answers_present boolean not null,
...
(
    ...
    constraint pk_submission_question_answers primary key (submission_id, answer_order),
    constraint uk_submission_question_answers_question unique (submission_id, question_id),
    constraint fk_submission_question_answers_submission_id foreign key (submission_id) references submissions (id)
);

create table submission_photo_requirement_answers
(
    submission_id           bigint       not null,
    answer_order            integer      not null,
    ...
    constraint pk_submission_photo_requirement_answers primary key (submission_id, answer_order),
    constraint uk_submission_photo_requirement_answers_requirement_file
        unique (submission_id, photo_requirement_id, file_id),
    constraint fk_submission_photo_requirement_answers_submission_id
        foreign key (submission_id) references submissions (id),
    constraint fk_submission_photo_requirement_answers_file_id foreign key (file_id) references file_assets (id)
);

create index idx_submission_photo_requirement_answers_file_id
    on submission_photo_requirement_answers (file_id);

create table submission_video_requirement_answers
(
    submission_id           bigint        not null,
    answer_order            integer       not null,
    ...
    constraint pk_submission_video_requirement_answers primary key (submission_id, answer_order),
    constraint uk_submission_video_requirement_answers_requirement unique (submission_id, video_requirement_id),
    constraint fk_submission_video_requirement_answers_submission_id
        foreign key (submission_id) references submissions (id)
);
